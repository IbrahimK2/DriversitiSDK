...
+ (nullable NSError *)errorWithSalInitializationErrorCode:(int)salErrorCode;

+ (nullable NSError *)errorWithApioErrorCode:(int)errorCode description:(nullable NSString *)localizedDescription;
